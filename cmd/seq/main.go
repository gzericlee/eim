...
func newCliApp() *cli.App {
	...
	app.Action = func(c *cli.Context) error {
		...
		log.Info(fmt.Sprintf("%v service started successfully", version.ServiceName), zap.String("addr", fmt.Sprintf("%v:%v", config.SystemConfig.LocalIp, config.SystemConfig.SeqSvr.RpcPort)))
