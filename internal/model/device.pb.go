...
type Device struct {
	...
	DeviceId      string                 `protobuf:"bytes,1,opt,name=device_id,json=deviceId,proto3" json:"device_id" bson:"device_id"`
	UserId        string                 `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id" bson:"user_id"`
	DeviceType    string                 `protobuf:"bytes,3,opt,name=device_type,json=deviceType,proto3" json:"device_type" bson:"device_type"`
	DeviceVersion string                 `protobuf:"bytes,4,opt,name=device_version,json=deviceVersion,proto3" json:"device_version" bson:"device_version"`
	GatewayIp     string                 `protobuf:"bytes,5,opt,name=gateway_ip,json=gatewayIp,proto3" json:"gateway_ip" bson:"gateway_ip"`
	FromId        string                 `protobuf:"bytes,6,opt,name=from_id,json=fromId,proto3" json:"from_id" bson:"from_id"`
	OnlineAt      *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=online_at,json=onlineAt,proto3" json:"online_at" bson:"online_at"`
	OfflineAt     *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=offline_at,json=offlineAt,proto3" json:"offline_at" bson:"offline_at"`
...
func (x *Device) GetFromId() string {
	if x != nil {
		return x.FromId
	}
	return ""
...
var file_internal_model_device_proto_rawDesc = []byte{
	...
	,
