...
type BizMember struct {
	...
	CreatedBy string `protobuf:"bytes,8,opt,name=created_by,json=createdBy,proto3" json:"created_by" bson:"created_by"`
	// @gotags: bson:"updated_by" json:"updated_by"
	UpdatedBy string `protobuf:"bytes,9,opt,name=updated_by,json=updatedBy,proto3" json:"updated_by" bson:"updated_by"`
	// @gotags: bson:"attributes" json:"attributes"
	Attributes map[string]string `protobuf:"bytes,10,rep,name=attributes,proto3" json:"attributes" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"attributes"`
}
...
func (x *BizMember) GetCreatedBy() string {
	if x != nil {
		return x.CreatedBy
	}
	return ""
...
func (x *BizMember) GetUpdatedBy() string {
	if x != nil {
		return x.UpdatedBy
	}
	return ""
...
var file_biz_member_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0xab, 0x03, 0x0a, 0x09, 0x42, 0x69,
	...
	0x61, 0x74, 0x65, 0x64, 0x42, 0x79, 0x12, 0x40, 0x0a, 0x0a, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62,
	0x75, 0x74, 0x65, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x42, 0x69, 0x7a, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x2e, 0x41, 0x74, 0x74,
