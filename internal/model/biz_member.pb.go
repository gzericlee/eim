...
type BizMember struct {
	...
	BizType string `protobuf:"bytes,2,opt,name=bizType,proto3" json:"bizType,omitempty" bson:"biz_type"`
	UserId  string `protobuf:"bytes,3,opt,name=userId,proto3" json:"userId,omitempty" bson:"user_id"`
	AckSeq  int64  `protobuf:"varint,4,opt,name=ackSeq,proto3" json:"ackSeq,omitempty" bson:"ack_seq"`
}
...
func (x *BizMember) GetBizType() string {
	if x != nil {
		return x.BizType
	}
	return ""
...
func (x *BizMember) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *BizMember) GetAckSeq() int64 {
	if x != nil {
		return x.AckSeq
	}
	return 0
...
var file_internal_model_biz_member_proto_rawDesc = []byte{
	...
	,
